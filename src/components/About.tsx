  ...
  const cards = [
    {
      ...
      gradient: 'from-[#C4521A]/30 to-transparent',
      borderColor: 'group-hover:border-[#C4521A]/50 hover:shadow-[0_0_40px_rgba(196,82,26,0.15)]',
    ...
    },
    {
      ...
      borderColor: 'group-hover:border-blue-500/50 hover:shadow-[0_0_40px_rgba(59,130,246,0.15)]',
    ...
    },
    {
      ...
      borderColor: 'group-hover:border-emerald-500/50 hover:shadow-[0_0_40px_rgba(16,185,129,0.15)]',
    ...
    },
    {
      ...
      borderColor: 'group-hover:border-purple-500/50 hover:shadow-[0_0_40px_rgba(168,85,247,0.15)]',
      className: 'md:col-span-1 md:row-span-1', // Square
    },
    {
      ...
      borderColor: 'group-hover:border-pink-500/50 hover:shadow-[0_0_40px_rgba(236,72,153,0.15)]',
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full relative z-10">
        ...
        >
          <div>
            ...
            <div className="w-24 h-2 bg-gradient-to-r from-[#C4521A] to-transparent mt-8 rounded-full" />
          </div>
          ...
          {cards.map((card, idx) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="w-16 h-16 rounded-2xl bg-black/40 border border-white/10 flex items-center justify-center mb-6 shadow-inner group-hover:scale-110 group-hover:rotate-[15deg] transition-transform duration-500 ease-out">
                  {card.icon}
                </div>
              ...
              <div className="absolute top-8 right-8 opacity-0 -translate-x-4 translate-y-4 group-hover:opacity-100 group-hover:translate-x-0 group-hover:translate-y-0 transition-all duration-500 ease-out text-white/40">
