...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={containerRef} className="py-24 relative overflow-hidden bg-black">
      
      {/* Background Rotating Fan Image Layer */}
      <div className="absolute inset-0 w-full opacity-40 mix-blend-screen pointer-events-none flex items-center justify-center">
        <motion.img 
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12 flex flex-col items-center pt-24">
        ...
        >
          <p className="text-[#a1a1aa] uppercase tracking-[0.2em] text-xs font-semibold mb-4">
            My Skillset
          </p>
          ...
          {techStack.map((skill, idx) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.4, delay: (idx % 10) * 0.05 }} /* Staggered popping effect based on row modulus */
                className="flex items-center gap-2.5 px-5 py-2.5 bg-[#121212]/90 backdrop-blur-md border border-white/10 rounded-full hover:bg-white/5 hover:border-white/20 transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.5)] cursor-default group"
              >
                <Icon 
